                ...
                <div class="products-columns">
                    @foreach($games as $game)
                        <div class="products-columns__item">
                            <div class="products-columns__item__title-product"><a href="{{route('shop.product',['id'=>$game->id])}}" class="products-columns__item__title-product__link">{{$game->name}}</a></div>
                            <div class="products-columns__item__thumbnail"><a href="{{route('shop.product',['id'=>$game->id])}}" class="products-columns__item__thumbnail__link"><img src="/public/img/cover/{{$game->picture}}" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                            <div class="products-columns__item__description"><span class="products-price">{{$game->price}} руб</span><a href="{{route('shop.product',['id'=>$game->id])}}" class="btn btn-blue">Купить</a></div>
                        </div>
                    @endforeach
                </div>
            </div>
