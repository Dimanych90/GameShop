...
<div class="main-wrapper">
    <header class="main-header">
        <div class="logotype-container"><a href="{{route('shop.main')}}" class="logotype-link"><img src="/public/img/logo.png" alt="Логотип"></a></div>
        <nav class="main-navigation">
            <ul class="nav-list">
                <li class="nav-list__item"><a href="{{route('shop.main')}}" class="nav-list__item__link">Главная</a></li>
                <li class="nav-list__item"><a href="{{route('shop.cart1')}}" class="nav-list__item__link">Мои заказы</a></li>
                <li class="nav-list__item"><a href="{{route('shop.news')}}" class="nav-list__item__link">Новости</a></li>
                <li class="nav-list__item"><a href="{{route('shop.about')}}" class="nav-list__item__link">О компании</a></li>
            </ul>
        </nav>
        ...
        <div class="header-container">
            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        <div class="authorization-block"><a href="{{ route('login') }}" class="authorization-block__link">Войти</a></div>
...
<div class="middle">
        ...
        <div class="sidebar-item">
            ...
            <div class="sidebar-item__content">
                <ul class="sidebar-category">
                    <li class="sidebar-category__item"><a href="{{route('shop.action')}}" class="sidebar-category__item__link">Action</a></li>
                    <li class="sidebar-category__item"><a href="{{route('shop.rpg')}}" class="sidebar-category__item__link">RPG</a></li>
                    <li class="sidebar-category__item"><a href="{{route('shop.online')}}" class="sidebar-category__item__link">Онлайн-игры</a></li>
                    <li class="sidebar-category__item"><a href="{{route('shop.strategy')}}" class="sidebar-category__item__link">Стратегии</a></li>
                </ul>
            </div>
        </div>
        <div class="sidebar-item">
    ...
    <div class="content-head__container">
        <div class="content-head__title-wrap">
            <div class="content-head__title-wrap__title bcg-title">{{$game->name}}</div>
        </div>
            ...
            <div class="content-main__container">
                <div class="news-block content-text">
                    <a href="{{route('shop.picture',['id'=>$game->id])}}"><img src="/public/img/cover/{{$game->picture}}" alt="Image" class="alignleft img-news"></a>
                    <p>
                    {{$game->discription}}
                    </p>
                </div>
        ...
        <br>
        <br>
        <div>  <span class="products-price">{{$game->price}} руб</span><br><br><a href="{{route('shop.form',['id'=>$game->id])}}" class="btn btn-blue">Купить</a></div>
            ...
            <div class="content-main__container">
                <div class="products-columns">
                    <div class="products-columns__item">
                        ...
                        <div class="products-columns__item__thumbnail"><a href="#" class="products-columns__item__thumbnail__link"><img src="/public/img/cover/game-1.jpg" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                    ...
                    <div class="products-columns__item">
                        ...
                        <div class="products-columns__item__thumbnail"><a href="#" class="products-columns__item__thumbnail__link"><img src="/public/img/cover/game-2.jpg" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                        <div class="products-columns__item__description"><span class="products-price">400 руб</span><a href="#" class="btn btn-blue">Купить</a></div>
                    </div>
                    <div class="products-columns__item">
                        ...
                        <div class="products-columns__item__thumbnail"><a href="#" class="products-columns__item__thumbnail__link"><img src="/public/img/cover/game-3.jpg" alt="Preview-image" class="products-columns__item__thumbnail__img"></a></div>
                        <div class="products-columns__item__description"><span class="products-price">400 руб</span><a href="#" class="btn btn-blue">Купить</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="random-product-container">
            ...
            <div class="random-product-container__content">
                <div class="item-product">
                    <div class="item-product__title-product"><a href="{{route('shop.product',['id'=>$onegame->id])}}" class="item-product__title-product__link">{{$onegame->name}}</a></div>
                    <div class="item-product__thumbnail"><a href="{{route('shop.picture',['id'=>$onegame->id])}}" class="item-product__thumbnail__link"><img src="/public/img/cover/{{$onegame->picture}}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                    <div class="item-product__description">
                        <div class="item-product__description__products-price"><span class="products-price">{{$onegame->price}} руб</span></div>
                        <div class="item-product__description__btn-block"><a href="{{route('shop.form',['id'=>$onegame->id])}}" class="btn btn-blue">Купить</a></div>
                    </div>
                </div>
            </div>
        </div>
