        ...
        <div class="main-content">
          ...
          <div class="content-middle">
              ...
              <div class="content-head__search-block">
                <div class="search-container">
                  <form class="search-container__form">
                    <input type="search" class="search-container__form__input">
            ...
            <div class="content-main__container">
              <div class="cart-product-list">
                ...
                <div class="cart-product-list__item">
                  <div class="cart-product__item__product-photo"><img src="/public/img/cover/{{$order->picture}}" class="cart-product__item__product-photo__image"></div>
                  <div class="cart-product__item__product-name">
                    <div class="cart-product__item__product-name__content"><a href="{{route('shop.product',['id'=>$order->id])}}">{{$order->nameofthegame}}</a></div>
                  </div>
            ...
            <div class="content-footer__container">
              <ul class="page-nav">
                <li class="page-nav__item"><a href="{{route('shop.cart1')}}" class="page-nav__item__link"><i class="fa fa-angle-double-left"></i></a></li>
                <li class="page-nav__item"><a href="{{route('shop.cart2')}}" class="page-nav__item__link">1</a></li>
...
{{--                <li class="page-nav__item"><a href="#" class="page-nav__item__link">5</a></li>--}}
                <li class="page-nav__item"><a href="{{route('shop.cart2')}}" class="page-nav__item__link"><i class="fa fa-angle-double-right"></i></a></li>
              </ul>
            </div>
          </div>
